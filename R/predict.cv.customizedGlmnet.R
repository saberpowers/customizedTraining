#' Make predictions from a \code{cv.customizedGlmnet} object
#' 
#' Returns predictions for test set provided at time of fitting, using
#' regulariztion parameter which minimizes CV error
#' 
#' @param object a fitted \code{cv.customizedGlmnet} object
#' @param ... additional arguments to be passed to \code{predict.customizedGlmnet}
#' 
#' @return a vector of predictions corresponding to the test set provided when the model
